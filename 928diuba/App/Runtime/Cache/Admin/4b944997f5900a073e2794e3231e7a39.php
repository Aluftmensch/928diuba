...
<td><img src="/928diuba/Public/Admin/photo/<?php echo ($vo["photo"]); ?>" width="50" height="50"></td>
<td>
...
<td><a href="/928diuba/Admin/Index/edituser/id/<?php echo ($vo["id"]); ?>" >修改</a>|<?php if(($vo["state"] == 0)): ?><a href="/928diuba/Admin/Index/changestate/id/<?php echo ($vo["id"]); ?>/state/<?php echo ($vo["state"]); ?>">暂停使用</a>
    <?php else: ?>
      <a href="/928diuba/Admin/Index/changestate/id/<?php echo ($vo["id"]); ?>/state/<?php echo ($vo["state"]); ?>">取消禁用</a><?php endif; ?>
|<a href="/928diuba/Admin/Index/edituser/id/<?php echo ($vo["id"]); ?>" >密码重置</a>|<a href="/928diuba/Admin/Index/deluser/id/<?php echo ($vo["id"]); ?>" >删除</a></td>
